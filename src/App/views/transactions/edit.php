...
<section class="max-w-2xl mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <input value="<?php echo e($transaction['descrip']); ?>" name="description" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />

            <?php if (array_key_exists('descrip', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php echo $errors['descrip'][0]; ?>
                </div>
            <?php endif; ?>
        </label>
        <label class="block">
